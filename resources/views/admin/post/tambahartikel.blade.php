...
@section('page-header')
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <a href="/data/artikel" class="btn btn-primary" type="submit">Simpan</a>
                                        <a href="/data/artikel" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        judul.addEventListener('change', function() {
            fetch('/data/artikel/tambahartikel/checkSlug?judul=' + judul.value)

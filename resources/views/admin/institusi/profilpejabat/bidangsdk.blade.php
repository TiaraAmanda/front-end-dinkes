            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Halaman Bagian Bidang Sumber Daya Kesehatan</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <a href="/profilpejabat/tambahbidangsdk" class="btn btn-primary">Tambah Profil Pejabat</a>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>KEPALA BIDANG SUMBER DAYA KESEHATAN</td>
                                                <td>MOHAMMAD YOTO, SKM, M.Kes</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>KEPALA SEKSI KEFARMASIAN</td>
                                                <td>-</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>KEPALA SEKSI ALAT KESEHATAN DAN PERBEKALAN RUMAH TANGGA</td>
                                                <td>Drs MUHAMMAD ARIF ZAIDI, Apt</td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>KEPALA SEKSI SUMBER DAYA MANUSIA KESEHATAN</td>
                                                <td>-</td>
                                            </tr>
                                        </tbody>
                                    </table>

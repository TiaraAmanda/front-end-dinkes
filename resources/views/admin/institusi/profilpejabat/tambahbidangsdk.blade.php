            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tambah Bagian Bidang Sumber Daya Kesehatan</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <a href="/profilpejabat/bidangsdk" class="btn btn-primary" type="submit">Simpan</a>
                                        <a href="/profilpejabat/bidangsdk" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                            </div>
                        </div>

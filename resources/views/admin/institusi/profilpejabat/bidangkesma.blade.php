            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Halaman Bagian Kesehatan Masyarakat</div>
                    </div>
                    <div class="card-body">
                        <a href="/profilpejabat/tambahbidangkesma" class="btn btn-primary">Tambah Profil Pejabat</a>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>KEPALA BIDANG KESEHATAN MASYARAKAT</td>
                                                <td>drg. VITRIA DEWI, Msi</td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>KEPALA SEKSI KESEHATAN KELUARGA DAN GIZI MASYARAKAT</td>
                                                <td>dr WARITSAH SUKARJIYAH</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>KEPALA SEKSI KESEHATAN LINGKUNGAN, KESEHATAN KERJA DAN OLAH RAGA</td>
                                                <td>-</td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>KEPALA SEKSI PROMOSI KESEHATAN</td>
                                                <td>WAHYUTI ERIE PRASTIWI, SKM., M.Kes</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>

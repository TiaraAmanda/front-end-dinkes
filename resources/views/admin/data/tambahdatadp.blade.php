            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tambah Data Dokumen & Publikasi</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <form>
                                    <div class="form-group">
                                        <div class="mb-3">
                                            <input type="text" name="kategori_data" id="kategori_data"
                                                value="dokumen-publikasi" hidden>
                                    ...
                                    <div class="form-group">
                                        <a href="/datainformasi/dokumen-publikasi" class="btn btn-primary"
                                            type="submit">Ungah</a>
                                        <a href="/datainformasi/dokumen-publikasi" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                            </div>

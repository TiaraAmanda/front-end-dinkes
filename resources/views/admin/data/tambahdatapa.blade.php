            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tambah Data Peraturan & Aturan</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-12">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <a href="/datainformasi/peraturan-aturan" class="btn btn-primary"
                                            type="submit">Ungah</a>
                                        <a href="/datainformasi/peraturan-aturan" class="btn btn-danger">Batal</a>
                                    </div>
                                </form>
                            </div>
